...
class OWnanopore_fusion_S3_download(OWBwBWidget):
    name = "nanopore_fusion_S3_download"
    description = "Enter and output a file"
    priority = 10
    icon = getIconName(__file__,"downloadS3.png")
    want_main_area = False
    docker_image_name = "biodepot/s3download"
    docker_image_tag = "1.16.272__python_3.8.0__alpine-3.10__675383a6"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"nanopore_fusion_S3_download")) as f:
