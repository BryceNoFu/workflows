...
class OWGTEx_bamtofastq(OWBwBWidget):
    name = "GTEx_bamtofastq"
    description = "Broad's bam to fastq method for GTEx samples"
    priority = 10
    icon = getIconName(__file__,"broadlogo_400x400.jpg")
