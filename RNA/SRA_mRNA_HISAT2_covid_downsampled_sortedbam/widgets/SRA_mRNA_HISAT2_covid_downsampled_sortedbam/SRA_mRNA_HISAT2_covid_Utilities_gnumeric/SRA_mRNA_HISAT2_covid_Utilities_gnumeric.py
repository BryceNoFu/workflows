...
class OWSRA_mRNA_HISAT2_covid_Utilities_gnumeric(OWBwBWidget):
    name = "SRA_mRNA_HISAT2_covid_Utilities_gnumeric"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"SRA_mRNA_HISAT2_covid_Utilities_gnumeric")) as f:
