...
class OWStart(OWBwBWidget):
    ...
    outputs = [("work_dir",str),("genome_dir",str),("genome_file",str),("sra_ids",str),("mate_1",str),("mate_2",str),("unpaired",str),("sam_output",str),("hisat2_idx",str),("annotation_gtf",str),("gzip",str),("bam_output",str),("sorted_bam_output",str),("metafile",str),("sorted_sam_output",str)]
    ...
    def handleOutputs(self):
        ...
        outputValue=None
        if hasattr(self,"sorted_sam_output"):
            outputValue=getattr(self,"sorted_sam_output")
        self.send("sorted_sam_output", outputValue)
