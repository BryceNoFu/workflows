...
class OWSRA_mRNA_HISAT2_covid_HISAT2_Align_1(OWBwBWidget):
    name = "SRA_mRNA_HISAT2_covid_HISAT2_Align_1"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"SRA_mRNA_HISAT2_covid_HISAT2_Align_1")) as f:
