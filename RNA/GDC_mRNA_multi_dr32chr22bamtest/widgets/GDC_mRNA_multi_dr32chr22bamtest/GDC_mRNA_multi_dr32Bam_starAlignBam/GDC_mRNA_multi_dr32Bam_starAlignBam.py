...
class OWGDC_mRNA_multi_dr32Bam_starAlignBam(OWBwBWidget):
    name = "GDC_mRNA_multi_dr32Bam_starAlignBam"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"GDC_mRNA_multi_dr32Bam_starAlignBam")) as f:
