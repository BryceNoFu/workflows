...
class OWUtilities_fastqDump(OWBwBWidget):
    ...
    inputs = [("Trigger",str,"handleInputsTrigger"),("OutputDir",str,"handleInputsOutputDir"),("sraids",str,"handleInputssraids"),("gzip",str,"handleInputsgzip")]
    ...
    def handleInputssraids(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputsgzip(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("gzip", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
