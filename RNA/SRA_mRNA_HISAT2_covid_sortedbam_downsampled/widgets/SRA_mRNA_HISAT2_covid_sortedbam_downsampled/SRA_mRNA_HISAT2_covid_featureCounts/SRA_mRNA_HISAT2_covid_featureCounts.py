...
class OWSRA_mRNA_HISAT2_covid_featureCounts(OWBwBWidget):
    name = "SRA_mRNA_HISAT2_covid_featureCounts"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"SRA_mRNA_HISAT2_covid_featureCounts")) as f:
