...
class OWSRA_mRNA_HISAT2_covid_downloadURL(OWBwBWidget):
    name = "SRA_mRNA_HISAT2_covid_downloadURL"
    description = "Downloads files from URL"
    priority = 1
    icon = getIconName(__file__,"download.png")
    want_main_area = False
    docker_image_name = "biodepot/downloadurl"
    docker_image_tag = "alpine_3.15__919a611c"
    ...
    def __init__(self):
        ...
        with open(getJsonName(__file__,"SRA_mRNA_HISAT2_covid_downloadURL")) as f:
